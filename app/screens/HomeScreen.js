...
import { Image, Text, TextInput, View, ImageBackground, TouchableOpacity, Dimensions, FlatList } from "react-native";
...
const HomeScreen = () => {
  ...
  const renderSections = () => {
    return [
      ...
      // Give a hand section
      <View key="giveHand" style={{ width: Dimensions.get("window").width - 30, height: 200 }} className="m-4 overflow-hidden bg-white rounded-lg shadow-lg">
        <ImageBackground
        ...
        >
          <View className="justify-center flex-1 p-4 bg-black/30">
            <Text className="mb-2 text-xl font-black text-white">Be a Hero, Deliver Hope!</Text>
            <Text className="mb-4 font-medium text-white">Join our mission to fight food waste and feed those in need.</Text>
            <TouchableOpacity className="bg-[#00CCBB] rounded-full px-4 py-2 mt-2 self-start">
              <Text className="font-bold text-center text-white">Sign Up for Delivery</Text>
            </TouchableOpacity>
          </View>
        </ImageBackground>
      </View>
